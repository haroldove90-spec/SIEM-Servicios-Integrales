      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-5 rounded-2xl border border-slate-200 shadow-xs">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="px-4 py-2 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-semibold text-xs shadow-md shadow-blue-100 transition flex items-center space-x-1.5 shrink-0"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-3">
          ...
          <div className="md:col-span-5 relative">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-2 text-xs bg-slate-50 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-slate-800"
            />
          </div>
          ...
          <div className="md:col-span-3">
            <select
              ...
              className="w-full px-3 py-2 text-xs bg-slate-50 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 font-medium text-slate-700"
            >
